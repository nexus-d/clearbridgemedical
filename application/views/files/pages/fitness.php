                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="department-header mt-20">
                                <div class="department-details">
                                    <h2 class="department-name">Fitness</h2>
...
<div class="thumbnail"><a href="medical-services/kenkodo">
<img alt="" src="assets/images/page-header-2.jpg"> </a>
</div>
                        </div>
                        <div class="col-sm-12">
                         <h4 class="department-loc">Introduction</h4>
                         ...
                         <h2 class="heading">Type of Test</h2>
                        <div class="col-sm-6">
                            <div class="iconbox-2">
                                ...
                                <div class="iconbox-content">
                                     <a href="#"> <h4 class="heading">Metabolomic Test</h4>
                                    <p>Behind the word mountains, far from the countries Vokalia.</p></a>
                                    <a href="#">Read More</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="iconbox-2">
                                ...
                                <div class="iconbox-content">
                                    <a href="#"><h4 class="heading">Metabolic Test</h4>
                                    <p>Behind the word mountains, far from the countries Vokalia.</p></a>
                                      <a href="#">Read More</a>
                                </div>
                            </div>
                ...
                <div class="widget ">
                <h4 class="heading">We also have other programs </h4>
